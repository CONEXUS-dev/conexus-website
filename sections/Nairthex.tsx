      ...
      <article className="grid grid-cols-12 gap-8 border border-white/20 p-6 md:p-10">
        ...
        <div className="col-span-12 flex flex-col justify-between md:col-span-7">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <a href={product.enter.href} className="inline-flex min-h-11 w-full items-center justify-center border border-ember px-5 py-3 text-center text-[0.75rem] uppercase tracking-[0.18em] text-ember transition-colors hover:bg-ember hover:text-void focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ember focus-visible:ring-offset-2 focus-visible:ring-offset-void sm:w-auto">
              {product.enter.label} →
            </a>
